...
export default function FloatingCTA() {
  ...
  return (
    <a
      ...
      className="btn-whatsapp group fixed bottom-5 right-5 z-40 min-h-11 min-w-11 p-3 shadow-lift transition hover:pr-5 focus-visible:ring-offset-2 print:hidden sm:bottom-6 sm:right-6"
    >
