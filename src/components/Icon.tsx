...
const paths: Record<string, ReactElement> = {
  ...
  whatsapp: (
    <path d="M20.5 3.5A10.5 10.5 0 0 0 3.2 16.3L2 22l5.85-1.18A10.5 10.5 0 1 0 20.5 3.5zM12 20.05a8.05 8.05 0 0 1-4.1-1.13l-.29-.17-3.47.7.74-3.37-.19-.31a8.05 8.05 0 1 1 7.31 4.28z" />
  ),
};
